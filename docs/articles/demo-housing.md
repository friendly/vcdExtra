...
![](fig/demo-housing-mosaic-glm0a-1.png)
...
![](fig/demo-housing-mosaic-glm0b-1.png)
...
revised model `house.glm1`. The difference, \\G^2(M1 \| M0) = G^2 (12) =
178.79\\ tests the collective additional fit provided by the two-way
...
![](fig/demo-housing-mosaic-glm1-1.png)
...
deviance \\G^2\\ from 38.66 to 16.11. The difference, \\G^2(M1 + ITS \|
M1) = G^2 (12) = 22.55\\ reflects a substantial improvement. The
remaining two-way interaction terms reduce the deviance by smaller and
non-significant amounts, relative to `house.glm1`.
