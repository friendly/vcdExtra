...
![Spine plots for the \`Arthritis\` data](fig/tut05-spine1-1.png)![Spine
plots for the \`Arthritis\` data](fig/tut05-spine1-2.png)
...
variation of Improved with Age.](fig/tut05-cdplot-1.png)
...
specifying `formula = y ~ poly(x,2)` (, right).
...
{#fig:donner3}](fig/tut05-donner3a-1.png)![Logistic regression plots for
the \`Donner\` data showing survival vs. age, by sex. Left: linear
logistic model; right: quadratic model
{#fig:donner3}](fig/tut05-donner3a-2.png)
