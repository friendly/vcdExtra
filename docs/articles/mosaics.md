...
\`shading_max\`](fig/tut04-Arthritis1-1.png)
...
![Mosaic plot for the \`Arthritis\` data, using
\`shading_Friendly\`](fig/tut04-Arthritis2-1.png)
...
![](fig/tut04-housetasks-mos1-1.png)
...
![](fig/tut04-housetasks-ca-plot-1.png)
...
![](fig/tut04-housetasks-mos2-1.png)
