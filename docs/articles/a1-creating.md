...
you want to re-order the *dimensions* of an $`n`$-way table, or change
...
table of `Treatment` $`\times`$`Sex` $`\times`$`Improved`. Note the use
of [`with()`](https://rdrr.io/r/base/with.html) to avoid having to use
