...
- **`MASS::dropterm()`** is a similar facility for `loglm` objects but is
  relatively obscure. But it does seem to do what I'm thinking of
...
#              Df     AIC     LRT Pr(Chi)    
# <none>            58.20                    
# Admit:Gender  1   57.74    1.53  0.2159    
# Admit:Dept    5  811.61  763.40  <2e-16 ***
# Gender:Dept   5 1176.90 1128.70  <2e-16 ***
# ---
