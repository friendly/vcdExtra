...
The \codefun{xtabs} function allows you to create cross-tabulations of data using formula style input.
...
The strucplot framework in \pkg{vcd} provides an extremely large variety of
