...
```{r read-datasets}
dsets_tagged <- read_excel(here::here("inst", "vcdExtra-datasets.xlsx"), 
...
```{r read-tags}
tags <- read_excel(here::here("inst", "vcdExtra-datasets.xlsx"), 
                   sheet="tags")
head(tags)
```
...
It turns each `dataset` name into a link to `help(dataset)`.
