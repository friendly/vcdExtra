...
coefficient for the linear-by-linear term
...
degrees of freedom. The plot below uses a log scale for BIc to emphasize differences among better fitting models. (The code for this plot is shown
on p. 399 of @FriendlyMeyer:2016:DDAR).

![](fig/hauser-model-plot.png){width=60%}
