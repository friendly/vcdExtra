...
The purpose of this document was to illustrate inconsistent results by the `vcdExtra 0.7-5` package when doing a CMH analysis under certain scenarios. We will use a mock data set to compare the results obtained from SAS's Proc FREQ and R's `vcdExtra` package.

Status: Updated 10 December 2025 to reflect current status of the `vcdExtra` package, version 0.8-7.
...
In this example, we see the results match with the previous R results, just the order of the rows in the output is different.
