...
[![Last Commit](https://img.shields.io/github/last-commit/friendly/vcdExtra)](https://github.com/friendly/vceExtra/)
...
It also adds extensions to modeling functions for models fit using `glm()` and `MASS::loglm()`, using the contruct `glmlist()`
