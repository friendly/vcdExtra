...
#' interactions.
#'
#' @aliases CMHtest CMHtest.formula CMHtest.default print.CMHtest
#'
...
#' components:
#' \item{table}{A matrix containing the test statistics, with
#'       columns \code{Chisq}, \code{Df} and \code{Prob} }
#' \item{names}{The names of
#'       the table row and column variables}
...
#' @seealso
#' \code{\link[coin]{cmh_test}} provides the CMH test of general
#' association;
#' \code{\link[coin]{lbl_test}} provides the CMH correlation test
