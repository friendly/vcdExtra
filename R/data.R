...
#' @name Reinis
#' @docType data
#' @format A 6-dimensional array resulting from cross-tabulating 6 binary variables
#' for 1841 observations. The variable names and their levels are:
#'
#' \tabular{rll}{
#'   No \tab Name        \tab Levels (meaning) \cr
#'   1  \tab `smoke`   \tab `"y", "n"` (smoking)\cr
#'   2  \tab `mental`  \tab `"y", "n"` (strenuous mental work)\cr
#'   3  \tab `phys`    \tab `"y", "n"` (strenuous physical work)\cr
#'   4  \tab `systol`  \tab `"y", "n"` (systolic blood pressure > 140)\cr
#'   5  \tab `protein` \tab `"y", "n"` (ratio of beta to alpha lipoproteins > 3)\cr
#'   6  \tab `family`  \tab `"y", "n"` (family history of CHD)\cr
#' }
#'
#' @references
...
#' *Annals of Mathematics and Artificial Intelligence*, 88, 951-972.
...
#' *Bratis. lek. Listy*, 76, 137-150.
#'
#' @source Originally from the \pkg{gRbase} package as `data(reinis, package = "gRbase")`
#' @keywords datasets
#' @examples
#' data(Reinis)
#' str(Reinis)
