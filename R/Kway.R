...
#' \code{environment(formula)}, typically the environment from which \code{glm}
#' is called.
#' @param \dots Other arguments passed to \code{glm}
#' @param order Highest order interaction of the models generated. Defaults to
#' the number of terms in the model formula.
#' @param prefix Prefix used to label the models fit in the \code{glmlist}
#' object.
